...
export class Hole {
    ...
    private create() {
        ...
        //
        this.bounceRegions.push(new BounceRegion(this.scene,0,0,19,20));
        Phaser.Display.Align.To.RightCenter(this.bounceRegions[0],this.greenHoles[0],0,0);
        ...
        //
        this.bounceRegions.push(new BounceRegion(this.scene,0,0,19,20));
        Phaser.Display.Align.To.RightCenter(this.bounceRegions[1],this.purpleHoles[0],0,0);
        ...
        //
        this.bounceRegions.push(new BounceRegion(this.scene,0,0,19,20));
        Phaser.Display.Align.To.RightCenter(this.bounceRegions[2],this.orangeHoles[0],0,0);

        this.purpleHoles.push(this.scene.add.image(0,0,'purpleHole').setDepth(0));
        Phaser.Display.Align.To.RightCenter(this.purpleHoles[1],this.orangeHoles[0], 16);
        //
        this.bounceRegions.push(new BounceRegion(this.scene,0,0,19,20));
        Phaser.Display.Align.To.RightCenter(this.bounceRegions[3],this.purpleHoles[1],0,0);
        ...
        this.scene.physics.add.collider(this.scene.bubblesBoard.gridGroup,this.bounceRegions, () => {
            console.log('collide happen when falling');
        });
    }
}